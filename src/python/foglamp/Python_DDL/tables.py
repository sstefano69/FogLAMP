""" 
The following is a file containing all the tables in terms of column_name, data_type, and PRIMARY KEY
...
log = sqlalchemy.Table('foglamp.log',sqlalchemy.MetaData(),
        ...
        sqlalchemy.Column('log',sqlalchemy.dialects.postgresql.JSONB),
...
assets = sqlalchemy.Table('foglamp.assets',sqlalchemy.MetaData(),
        ...
        sqlalchemy.Column('address',sqlalchemy.dialects.postgresql.INET), # NOT 100% this would work due to data-type
        sqlalchemy.Column('status_id',sqlalchemy.INTEGER),
        sqlalchemy.Column('properties',sqlalchemy.dialects.postgresql.JSONB),
...
asset_messages = sqlalchemy.Table('foglamp.asset_messages',sqlalchemy.MetaData(),
        ...
        sqlalchemy.Column('asset_id',sqlalchemy.INTEGER),
        sqlalchemy.Column('status_id',sqlalchemy.INTEGER),
        sqlalchemy.Column('message',sqlalchemy.dialects.postgresql.JSONB),
        sqlalchemy.Column('ts',sqlalchemy.TIMESTAMP))
...
readings = sqlalchemy.Table('foglamp.readings',sqlalchemy.MetaData(),
        ...
        sqlalchemy.Column('read_key',sqlalchemy.dialects.postgresql.UUID), # NOT 100% this would work due to data-type
        sqlalchemy.Column('reading',sqlalchemy.dialects.postgresql.JSONB),
...
destinations = sqlalchemy.Table('foglamp.destinations',sqlalchemy.MetaData(),
        ...
        sqlalchemy.Column('description',sqlalchemy.CHAR(255)),
        sqlalchemy.Column('properties',sqlalchemy.dialects.postgresql.JSONB),
        sqlalchemy.Column('address',sqlalchemy.dialects.postgresql.INET),
        sqlalchemy.Column('ts',sqlalchemy.TIMESTAMP))
...
streams = sqlalchemy.Table('foglamp.streams',sqlalchemy.MetaData(),
        ...
        sqlalchemy.Column('description',sqlalchemy.CHAR(255)),
        sqlalchemy.Column('properties',sqlalchemy.dialects.postgresql.JSONB),
        sqlalchemy.Column('filters',sqlalchemy.dialects.postgresql.JSONB),
...
configuration = sqlalchemy.Table('foglamp.configuration',sqlalchemy.MetaData(),
        ...
        sqlalchemy.Column('value',sqlalchemy.dialects.postgresql.JSONB),
        sqlalchemy.Column('ts',sqlalchemy.TIMESTAMP))
...
configuration_changes = sqlalchemy.Table('foglamp.configuration_changes',sqlalchemy.MetaData(),
        ...
        sqlalchemy.Column('configuration_value',sqlalchemy.dialects.postgresql.JSONB),
        sqlalchemy.Column('ts',sqlalchemy.TIMESTAMP))
...
clean_rules = sqlalchemy.Table('foglamp.clean_rules',sqlalchemy.MetaData(),
        ...
        sqlalchemy.Column('rule',sqlalchemy.dialects.postgresql.JSONB),
        sqlalchemy.Column('rule_check',sqlalchemy.dialects.postgresql.JSONB),
...
role_resource_permission = sqlalchemy.Table('foglamp.role_resource_permission', sqlalchemy.MetaData(),
        ...
        sqlalchemy.Column('access',sqlalchemy.dialects.postgresql.JSONB))
...
user_logins = sqlalchemy.Table('foglamp.user_logins',sqlalchemy.MetaData(),
        ...
        sqlalchemy.Column('ip',sqlalchemy.dialects.postgresql.INET),
        sqlalchemy.Column('ts',sqlalchemy.TIMESTAMP))
